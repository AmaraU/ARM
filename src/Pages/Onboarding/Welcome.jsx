...
export const Welcome = () => {
    ...
    return (
        <Stack alignItems={'center'} textAlign={'center'} spacing={5} py={'6%'} px={'25%'} bgImage={getImageUrl('onboardingBackground.png')} bgSize={'100% 100%'}>
            ...
            <Text mt={'-80px'} fontSize={'48px'} fontWeight={700} color={'#14142A'}>Welcome Adeola</Text>
            ...
            <Button onClick={()=>navigate('/signin')} id="continue" bg={'#A41857'} _hover={{bg: '#A41857'}} fontSize={'18px'} fontWeight={600} color={'#FFFFFF'} py={'12px'} w={'100%'}>Login</Button>
        </Stack>
    )
}
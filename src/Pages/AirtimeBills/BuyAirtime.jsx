...
import {
    Stack, Text, Box, Button, HStack,
    FormControl, FormLabel,
    Input, InputGroup, InputLeftElement,
    useDisclosure,
    Modal, ModalHeader, ModalCloseButton, ModalBody, ModalContent, ModalOverlay,
    ModalFooter,
...
export const BuyAirtime = () => {
    ...
    return (
        ...
        <Modal isCentered size='lg' closeOnOverlayClick={true} isOpen={isOpenConfirm} onClose={onCloseConfirm} >
            ...
            <ModalContent>
                <ModalHeader>
                    <Text textAlign='center' fontSize='18px' fontWeight={600} color='#101828'>Confirm Airtime Payment Details</Text>
                </ModalHeader>
                <ModalCloseButton />
                ...
                <div style={{ overflow: 'auto', maxHeight: '60vh' }}>
                    ...
                    <Stack w='100%' spacing='16px'>
                        ...
                        <HStack spacing='8px' alignItems='center'>
                            ...
                            <Stack spacing={0}>
                                <Text fontSize='14px' fontWeight={450} color='#667085'>NETWORK PROVIDER</Text>
                                <Text fontSize='18px' fontWeight={500} color='#A41856'>MTN</Text>
                            </Stack>
                        </HStack>
                        ...
                        <HStack spacing='8px' alignItems='center'>
                            ...
                            <Stack spacing={0}>
                                ...
                                <Text fontSize='18px' fontWeight={500} color='#A41856'>Adeola Obasanjo - 08101790957</Text>
                            </Stack>
                        </HStack>
                        ...
                        <HStack spacing='8px' alignItems='center'>
                            ...
                            <Stack spacing={0}>
                                ...
                                <Text fontSize='18px' fontWeight={500} color='#A41856'>₦3,000</Text>
                            </Stack>
                        </HStack>

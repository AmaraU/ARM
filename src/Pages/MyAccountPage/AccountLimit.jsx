...
export const AccountLimit = ({ backHome }) => {
            ...
            <Stack spacing='24px' alignItems='center' border='1px solid #EFECE9' bg='#FFFFFF' borderRadius='0 0 12px 12px' px='16px' pb='114px' pt='48px'>
                ...
                <Stack w='75%' justifyContent='space-between' spacing='24px'>
                    <Stack w='100%'>
                        ...
                        <Input h='48px' autoComplete="off" type="number" bg='#F7F7F7' border='1px solid #EAECF0' placeholder="₦200,000" _placeholder={{fontSize: '16px', color: '#667085'}} />
                    </Stack>
                    <Stack w='100%'>
                        <Text fontSize='16px' color='#101828'>PIN</Text>
                        <Input h='48px' autoComplete="off" maxLength={4} type="password" bg='#F7F7F7' border='1px solid #EAECF0' placeholder="****" _placeholder={{fontSize: '16px', color: '#667085'}} />
                    </Stack>
                </Stack>

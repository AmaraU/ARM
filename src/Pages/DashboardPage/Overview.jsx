...
import { getTransactionHistory } from "../../store/auth/transactions.slice";
...
export const Overview = () => {
  ...
  function copyToClipboard() {
    navigator.clipboard.writeText(casaAccountBalances[0]?.accountnumber);
      ...
      <Stack gap="20px" maxW="1500px">
        ...
        {showComplete && (
          <Box
            ...
            bgSize="25% auto"
            bgRepeat="no-repeat"
            backgroundPosition="bottom right 200px"
          >
            <HStack
              display="flex"
              justifyContent="space-between"
              backgroundImage={getImageUrl("arrowSquiggle.png")}
              bgSize="20% auto"
              bgRepeat="no-repeat"
            ...
            >
              <Box>
                ...
                <Text fontSize="12px" fontWeight={400} color="#A41857">
                  You need to complete your account setup to enjoy more services
                </Text>
                <Button
                  fontSize="12px"
                  fontWeight={700}

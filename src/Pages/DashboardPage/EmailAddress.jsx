...
export const EmailAddress = ({ moveToSecurity, proceed }) => {
    ...
    return (
        ...
        <Box>
            ...
            <Stack spacing={'24px'} alignItems={'center'} border={'1px solid #EFECE9'} bg={'#FFFFFF'} borderRadius={'0 0 12px 12px'} py={'16px'} pb={'114px'}>                                
                ...
                <Text fontSize={'16px'} color={'#667085'} textAlign={'center'}>A link will be sent to your email to validate it</Text>

                <FormControl w='80%'>
                    <FormLabel fontSize='16px' fontWeight={400} color='#101828'>Email Address</FormLabel>
                    <Input type='email' h='48px' bg='#F7F7F7' border='1px solid #EAECF0' fontSize='16px' color='#101828' value={'Contactmichaeleze@gmail.com'} disabled _disabled={{bg: '#EAECF0', color: '#8D9DA8'}}/>
                </FormControl>

                <Button
                    mt='16px' w='80%' h='48px' bg='#A41856' _hover={{bg: '#90164D'}}

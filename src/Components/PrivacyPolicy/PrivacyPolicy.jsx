...
import Logo from "../../../assets/logos/arm_logo.svg";
    ...
    return (
        ...
        <div className={styles.whole}>
            <div className={styles.wholeDiv}>
                ...
                <img src={Logo} alt="ARM" />

                <div className={styles.brownDiv}>
                    <h1>ARM MFB</h1>

                    <div className={styles.withDivide}>
                        <h2>Privacy Policy on Website</h2>
                    ...
                    <p>ARM/InfoSec/NDPR-DOC/020</p>
                    <p>Version 1.0</p>
                </div>

                <h4 id="Introduction">Introduction</h4>
                <p>
                    ARM Microfinance Bank (ARM MFB) is a subsidiary of the ARM  MFB, established to complement and strengthen the  MFB's presence in the financial services industry. 
                    Operating under a State Microfinance Bank license, ARM MFB aims to provide a broad range of banking services to both retail and SME customers, focusing primarily on Lagos. 
                    The bank positions itself as a key partner for young and middle-aged professionals, as well as micro, small, and medium-sized enterprises (MSMEs).

                    <br />
                    <br />

                    This Privacy Policy outlines the types of information we collect about you, the methods we use to gather this information, and how we process and share it. 
                    While you are not obligated to share your personal information, certain details will be required to access our services. 
                    Additionally, this policy explains the circumstances under which we may share your information with third parties, such as service providers and regulatory entities.
                </p>


                <h4 id="What we collect">What we collect</h4>
                <p>
                    We may collect the following Personal Data:
                    <ul>
                        <li>
                            <b>Personal identification information -</b> We collect and use information about You to administer Our business.
                            ...
                            <ul>
                                ...
                                <li>Any other information We may deem necessary and which may be determined by extant Nigerian laws and regulations.</li>
                            </ul>
                        </li>

                        <br />
                        We may collect personal identification information from you in a variety of ways, including, but not limited to, 
                        when you visit our Site, register on the Site, make payments for our products and services, subscribe to Our newsletter, 
                        respond to a survey, or fill out a form, and in connection features or resources made available on our Site.
                        <br />
                        <br />

                        <li style={{marginTop: '10px'}}>
                            <b>Non-personal identification information -</b> This is information received whenever You interact with Our Site. 
                            ...
                            <ul>
                                ...
                                <li>IP address and information that maybe derived from IP address, such as geographic location; and</li>
                    ...
                    ARM MFB uses the <b>True Depth API</b> within the camera module to enhance the liveness check during the Know Your Customer (KYC) process, 
                    as required by account opening regulations. 
                    This technology ensures that the video submitted is being recorded live and belongs to the user.
                </p>
                ...
                <p>
                    ...
                    <ul>
                        <li><b>Camera Intrinsic Matrix:</b> Information about the camera's internal properties.</li>
                        <li><b>Facial Expressions and Head Orientation:</b> To verify live interaction.</li>
                        <li><b>Camera Position:</b> To validate that the video is captured in real-time and is not pre-recorded.</li>
                    </ul>
                </p>
                ...
                <p>
                    <ul>
                        <li>The video is shared with a third-party service provider solely to confirm the user's identity.</li>
                        <li>The data is deleted after the verification process, in compliance with applicable laws and regulations.</li>
                    </ul>
                </p>


                <h4>Third-Party Obligations</h4>
                <p>
                    <ul>
                ...
                <p>
                    ...
                    This process ensures that ARM MFB meets regulatory requirements while prioritizing user privacy and security.
                </p>


                <h4 id="Why we collect">Why we collect your Personal Data</h4>
                <p>
                ...
                <h4 id="What we do">What we do with the information we gather?</h4>
                <p>
                    ...
                    <ul>
                        ...
                        <li>To respond to your enquiries about the ARM MFB;</li>
                    ...
                    <br />
                    The ARM MFB will not share with other parties, information which you may provide when using the Site, 
                    except to the extent necessary to provide services to you, further, to obtaining your consent.
                    <br />
                    <br />
                    With your express consent, we will share your personal data among subsidiaries within the ARM  MFB,
                    only to the extent of your permission, and which is necessary to provide services to you. 
                    In this case, your right to withdraw consent shall be exercisable at all times. 
                    ...
                    <b>Marketing</b>
                    <br />
                    We may wish to share with you, information about our products and services which we think you may be interested including those of our subsidiaries.
                    If you have agreed to receive marketing materials, you can always opt out at a later date.
                    You reserve the right at any time and at no cost to you, to stop us from contacting you for marketing purposes or giving your data to our subsidiaries.

                </p>

                <h4 id="How we collect">How we collect Personal Data</h4>
                <p>
                    ...
                    <ul>
                        ...
                        <li>
                            In the event that our ability to communicate with you is disrupted by reason of a change in your contact information, 
                            we shall take steps to re-establish same including procuring your personal data from third parties who possess the 
                            authority to disclose such information in compliance with applicable data protection laws.
                            Such information shall be used solely for the purpose of reconnecting with you and updating your previously provided information, 
                            and where required, to safeguard your interests
                        </li>
                    </ul>
                </p>


                <h4 id="Where we store">Where We Store Your Personal Data</h4>
                <p>
                    The Personal Data that we collect from you will be transferred to and stored at destinations within Nigeria. 
                ...
                <h4 id="do we use">Do We use Cookies?</h4>
                <p>
                    We use cookies to improve your browsing experience on our website. 
                    By browsing on our website, you consent to our use of cookies in accordance with our privacy policy.
                    ...
                    We need the cookies to enable technical performance of Our websites and allow us to 'remember' the choices you make and your preferences 
                    (Functionality) and to allow us collect certain information about how You navigate the Sites (Performance/Analytical).
                    <br />
                    By this, we are able to understand which parts of Our websites are interesting to You and which are not, 
                    as well as what We can do to improve them.
                </p>

                <h4 id="how we use">How We Use Cookies</h4>
                <p>
                    Cookies do not contain any information that personally identifies You, 
                    but Personal Data that We store about You may be linked, by us, to the information stored in and obtained from cookies.
                    The cookies used on Our website include those which are strictly necessary for access and navigation, 
                    cookies that track usage (performance cookies) and those used to remember your choices (functionality cookies).
                    We may use the Personal Data We obtain from Your use of our cookies for the following purposes:
                    ...
                    which is one of the most widespread and trusted analytics solutions on the web. 
                    This helps us to understand how You use the site and ways that We can improve Your experience.
                </p>

                <h4>Accepting, Declining and Disabling Cookies</h4>
                <p>
                    ...
                    However, this may prevent you from taking full advantage of the website. You can also disable cookies if You wish.
                    However, this will affect the functionality of Our website and many other websites that You visit.
                    Disabling cookies will usually result in also disabling certain functionality and features of this site.
                    Therefore, it is recommended that you do not disable cookies.
                </p>


                <h4 id="links to other">Links to other websites</h4>
                <p>
                    Our Site may contain links to other websites of interest.
                    However, once You have used these links to leave Our Site, You should note that We do not have any control over such websites.
                    Therefore, We cannot be responsible for the protection and privacy of any information which You
                    provide whilst visiting such websites and such websites are not governed by this Privacy Policy.
                    You should exercise caution and review the privacy statement(s) applicable to the websites.
                </p>

                
                <h4 id="controlling">Controlling your Personal Data</h4>
                <p>
                    You may choose to restrict the collection or use of your Personal Data in the following ways:

                    <ul>
                        <li>
                            Whenever You are asked to fill in a form on the Site, the privacy policy link will be available.
                            You can decide not to fill the form if you do not accept the terms of the policy;
                        </li>
                        <li>
                            If You have previously agreed to us using Your Personal Data for direct marketing purposes,
                            You may change Your mind at any time by emailing us at <a href="mailto: privacy@arm.com.ng">privacy@arm.com.ng</a>.
                        </li>
                    </ul>
                    ...
                    We may use Your Personal Data to send You promotional information about third parties which We think
                    You may find interesting subject to your written permission to do so.
                </p>


                <h4 id="how we protect">How we protect your Personal Data</h4>
                <p>
                    We are committed to ensuring that Your Personal Data information is secure.
                    In order to prevent unauthorised access or disclosure, We have put in place reasonable physical,
                    electronic and managerial procedures to safeguard and secure the Personal Data We collect online.
                    <br />
                    <br />
                    In particular, We adopt appropriate data collection, storage and processing practices and security measures to protect against
                    unauthorized access, alteration, disclosure or destruction of Your personal transaction information and data stored on our Site.
                    <br />
                    Sensitive and private data exchange between the Site and its Users happens over a secured communication channel and is encrypted and protected. 
                    Transactions are also handled over a secure payment gateway.
                    Also, the ARM MFB has implemented appropriate technical, physical and organisational measures designed to protect
                    Personal Data against accidental or unlawful destruction, accidental loss, damage, alteration,
                    unauthorised disclosure or access, as well as all other forms of unlawful processing.
                </p>


                <h4 id="retention">Retention of your Personal Data</h4>
                <p>
                    We maintain Personal Data not longer than we need to use it in accordance with the ARM MFB’s Data Retention Policy. In some circumstances, we may retain your Personal Data for longer periods if it is in accordance with regulatory, legal, tax or accounting obligations. The ARM MFB has an established retention procedure it applies to records and Personal Data collected and stored. In all cases, where your Personal Data is no longer required or you request for deletion, we will ensure it is disposed of in a secure manner.
                </p>
                

                <h4 id="sharing">Sharing your Personal Data</h4>
                <p>
                    We do not sell, trade, or rent Users Personal Data to others. 
                    We may share generic aggregated demographic information not linked to any Personal Data regarding visitors and users with our business partners, 
                    trusted affiliates and advertisers for the purposes outlined above. 
                    We will not disclose Your Personal Data to anyone outside the ARM MFB without Your consent to do so unless one of the following circumstances applies:
                    
                    <ol>
                        <li>
                            <b>With your consent</b>
                            <br />
                            We will share Personal Data with companies, organizations or individuals outside of the ARM MFB when We have your consent to do so.
                        ...
                        <li>
                            ...
                            <br />
                            We will share Personal Data with companies, organizations or individuals outside of the ARM MFB if we have a 
                            ...
                            <ul style={{marginTop: '4px'}}>
                                ...
                                <li>protect against harm to the rights, property or safety of the ARM  MFB , our Users or the public as required or permitted by law.</li>
                            </ul>
                        </li>
                    </ol>
                </p>
                ...
                <h4 id="your acceptance">Your acceptance of these terms</h4>
                <p>
                ...
                <h4 id="accessing and updating">Accessing and updating your Personal Data</h4>
                <p>
                ...
                <h4 id="your rights">Your Rights as a Data Subject</h4>
                <p>
                ...
                <h4 id="filing a complaint">Filing A Complaint</h4>
                <p>
                    In the event you are dissatisfied with the way in which we process your data we advise that you 
                    submit your complaint to our DPO via <a href="mailto:privacy@arm.com.ng">privacy@arm.com.ng</a>.
                ...
                <h4 id="compliance">Compliance with the Regulations</h4>
                <p>
                    ...
                    which describe how organisations including the ARM  MFB  must collect, handle and store Personal Data and applies regardless of whether data is stored electronically, on paper or on other materials.
                    
                    <br />
                    <br />

                    According to Applicable Law, ARM  MFB  shall notify Nigeria Data Protection Commission (the Commission) 
                ...
                <p>
                    ...
                    <br />
                    <br />
                    Contact Name: &ensp; Chukwu Augustine
                    <br />
                    Email: &ensp; <a href="mailto:privacy@arm.com.ng">privacy@arm.com.ng</a>
                    <br />
                    Telephone: &ensp; + 234 (1) 2701653
                </p>

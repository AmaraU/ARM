      ...
      <Stack maxW={"630px"}>
        ...
        <div className="loan-offer">
          <p>
            ...
            the Management of ARM MFB has considered and approved your request
          ...
          <ol>
            <li>
              ...
              and monthly compounding basis at ARM MFB’s Prime Lending Rate
              (PLR) currently at 27.5% per annum plus 3% leading to an initial

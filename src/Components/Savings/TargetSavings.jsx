    ...
    <div className={styles.whole}>
      ...
      <Tabs>
        <HStack alignItems='center' justifyContent='space-between' mr={4}>
          ...
          <Button onClick={showModal} bg='#A41857' _hover={{bg: '#90164D'}} borderRadius='34px' fontSize='13px' fontWeight={500} color='#FFFFFF'>Create New Target</Button>
        </HStack>
        ...
        <TabPanels>
          <TabPanel ml={-4}>
            ...
            {showSavings && <CardContainer title={'My Target Savings'}>
                        ...
                        {activeSavings.map((save, index) => (
                          <GridItem p='18px' borderRadius='8px' border='1px solid #EAECF0'>
                            <HStack justifyContent='space-between' mb='16px'>
                              ...
                              <Box bg='#3448F01A' px='8px' py='2px' borderRadius='34px'><Text fontSize='12px' fontWeight={450} color='#4E61FF'>₦{save.amount_saved/1000}k saved</Text></Box>
                            </HStack>

...
export const FixedSavingsDetails = ({ title, goBack, type, isMember=true }) => {
        ...
        <div>
            {step === 'deets' && <CardContainer title={title} moveToOne={goBack}>
                {type === 'group' && showWarning && <HStack mb='18px' maxWidth='700px' w='75%' bg='#FFF4DF' borderRadius='8px' p='16px' justifyContent='space-between'>
                    ...
                    <button onClick={()=>setShowWarning(false)}><img src={getImageUrl('icons/close.png')} style={{width: '16px', height: '16px'}} /></button>
                </HStack>}
                ...
                <Stack maxWidth="800px" width="80%" border='1px solid #EAECF0' borderRadius='8px' px='20px' py='25px' spacing={0}>
                    ...
                    <Text fontSize='12px' fontWeight={600} color='#A41857' mt='16px' mb='8px'>90 Days to Maturity</Text>
                    <progress className={styles.progress} max={13000000} value={13000000} />
                    ...
                    {type === 'personal' && <HStack justifyContent='space-between' mt='16px' spacing='24px'>
                        ...
                        <Stack spacing={2} w='100%'>
                            <Text fontSize='12px' fontWeight={450} color='#667085' textAlign='right'>INTEREST EARNED (8% PA)</Text>
                            <Text fontSize='18px' fontWeight={600} color='#101828' textAlign='right'>₦380,000</Text>
                        </Stack>
                    </HStack>}

                    {type === 'group' && <HStack justifyContent='space-between' mt='16px' spacing='24px'>
                        <Stack spacing={2} w='100%'>
                            <Text fontSize='12px' fontWeight={450} color='#667085'>INTEREST EARNED</Text>
                            <Text fontSize='18px' fontWeight={600} color='#101828'>₦2,080,000</Text>
                        </Stack>
                        ...
                        <Stack spacing={2} w='100%'>
                            <Text fontSize='12px' fontWeight={450} color='#667085'>INTEREST</Text>
                            <Text fontSize='18px' fontWeight={600} color='#101828'>8% P.A</Text>
                        </Stack>
                    </HStack>}
                </Stack>
                ...
                {type === 'personal' && <HStack justifyContent='space-between' spacing='24px' maxWidth="800px" width="80%">
                    ...
                    <Stack borderRadius='8px' border='1px solid #EAECF0' p='20px' w='100%'>
                        <Text fontSize='12px' fontWeight={450} color='#667085'>PAYOUT DATE</Text>
                ...
                {type === 'group' && <HStack justifyContent='space-between' spacing='24px' maxWidth="800px" width="80%">
                    ...
                    <Stack borderRadius='8px' border='1px solid #EAECF0' p='16px' w='100%'>
                        <Text fontSize='11px' fontWeight={450} color='#667085'>DAYS LEFT TO START</Text>
                        <Text fontSize='18px' fontWeight={600} color='#101828'>33 Days</Text>
                    </Stack>
                </HStack>}

                {!isMember && <Button mt='40px' w='80%' maxWidth='700px' h='48px' color='#FFFFFF' bg='#A41856' _hover={{bg: '#90164D'}} >Join Group</Button>}


                <HStack maxWidth="800px" width="80%" justifyContent='space-evenly' mt='40px'>
                    {type === 'group' && <Stack alignItems='center' cursor='pointer' onClick={handleTopUp}>
                    ...
                    {type === 'personal' && ACTIVITES.map((act, index) => (
                        <HStack key={index} justifyContent='space-between' borderBottom='0.5px solid #EAECF0' pt='16px'pb='4px'>
                            <HStack spacing={2} alignItems='start'>
                                ...
                                : act.type === 'edit' ? <img style={{width: '32px', height: '32px'}} src={getImageUrl('icons/greyEdit.png')} />
                                : act.type === 'create' ? <img style={{width: '32px', height: '32px'}} src={getImageUrl('icons/greyEdit.png')} />
                                : act.type === 'extend' ? <img style={{width: '32px', height: '32px'}} src={getImageUrl('icons/greyTopup.png')} />
                                : act.type === 'break' ? <img style={{width: '32px', height: '32px'}} src={getImageUrl('icons/redBreak.png')} />

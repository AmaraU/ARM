    ...
    <div className={styles.whole}>
      ...
      <Tabs>
        <HStack alignItems='center' justifyContent='space-between' mr={4}>
          ...
          <Button onClick={showModal} bg='#A41857' _hover={{bg: '#90164D'}} borderRadius='34px' fontSize='13px' fontWeight={500} color='#FFFFFF'>Create New Fixed Savings</Button>
        </HStack>
                  ...
                  <TabPanel>
                    {activeSavings.length === 0 ? (
                      <Stack alignItems='center'>
                        <img src={getImageUrl('icons/greyFixed.png')} style={{width: '90px', height: '90px'}} />
                        ...
                        {activeSavings.map((save, index) => (
                          <GridItem p='18px' borderRadius='8px' border='1px solid #EAECF0' key={index}>
                            <HStack justifyContent='space-between' mb='16px'>
                              ...
                              <Box bg='#3448F01A' px='8px' py='2px' borderRadius='34px'><Text fontSize='12px' fontWeight={450} color='#4E61FF'>₦{save.interest/1000}M Interest</Text></Box>
                            </HStack>
                            ...
                            <Button w='100%' color='#101828' fontSize='14px' bg='#EFECE9' _hover={{bg: '#EFECE9'}} onClick={()=>moveToDetails(save)}>View Details</Button>
                          </GridItem>
                        ))}

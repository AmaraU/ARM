    ...
    return (
        ...
        >
            ...
            <ModalContent>
                ...
                <ModalHeader>
                    <Text textAlign='center' fontSize='18px' fontWeight={600}>ARM MICROFINANCE BANK TERMS AND CONDITIONS</Text>
                </ModalHeader>
                ...
                <ModalBody p={0}>
                    <Stack py='16px' px='40px' gap='16px'>
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            1.1  ARM Microfinance Bank Limited(“ARMMFB”) is duly licensed by the Central Bank of Nigeria(“CBN”) to provide Microfinance banking services and other financial services to the public, and it also operates digitally.
                            <br /><br />
                            1.2  The “ARMMFB” Terms & Conditions(the “Conditions”) is a legally binding contract between you, the individual end user(collectively, “You” or “Your”) and ARMMFB Microfinance Bank Limited(“ARMMFB”, “us” or “we”, or the “Company”) and its affiliates and applies to Your use of all the banking services provided by or on behalf of ARMMFB in connection to the application(the “ARMMFB Services”) including but not limited to savings accounts, loan facilities, online payment services, internet - bank services, Mobile – bank Services and SMS bank services.
                            <br /><br />
                            1.3  ARMMFB reserves the right to modify the terms of the Conditions, any Terms of Use and other policies at any time by posting an updated version.ARMMFB will change the Conditions by posting a new version at such URL, so please continue to review the Conditions from time to time.To the fullest extent permitted under applicable Law, your continued use of the ARMMFB Services after any such modification constitutes your acceptance of the Conditions as modified and your agreement to be bound by same.If you do not agree to any modification of the Conditions, You must immediately stop accessing the ARMMFB Services.
                            <br /><br />
                        </Text>
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            <b>Account(s)</b>
                            <br />
                            Any savings or current account(s) of the Customer, opened with ARMMFB, used to perform banking operations.
                            <br /><br />
                            ...
                            <b>Payment Cards</b>
                            <br />
                            Payment Cards A payment-enabled card (e.g., Visa, MasterCard, Verve) issued by ARMMFB to customers for making payments and withdrawing funds. These cards may be debit, credit, or prepaid cards and must be used by the customer in accordance with ARMMFB's general rules, terms, and conditions, as well as applicable regulatory requirements.
                            <br /><br />
                            ...
                            <b>Operation</b>
                            <br />
                            Any payment, withdrawal, deposit or banking activity made by the Customer using Payment Cards or initiated from any other channel such as the digital banking platform for ARMMFB.
                            <br /><br />

                            <b>Remote Banking</b>
                            <br />
                            A set of banking products by using of which the Customer may make certain banking Operations/receive certain information without the need to physically visit ARMMFB. The Remote Banking includes the following banking products/services: using the Debit Card, online payments, internet and mobile banking, USSD banking, Agency Banking, SMS-banking, telephone banking, Email banking and any other channels that may be introduced by the bank in the future.
                            <br /><br />

                            <b>Services</b>
                            <br />
                            The banking services offered by ARMMFB under these Terms and Conditions and requested by the Customer including but not limited to the operation of savings, current and corporate accounts, loan facilities, online payment services, internet banking services, Mobile banking services, USSD banking services, Agency banking services and SMS bank services.
                            <br /><br />

                            <b>Third Party</b>
                            <br />
                            An entity or person other than ARMMFB, You, and Your or ARMMFB’s Affiliates
                            <br /><br />
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            3.1  To open and operate an account with ARMMFB, you must be at least (18) years of age, provide a valid identification card, proof of residence, fulfillment of our onboarding and Know-Your-Customer (KYC) checks, in line with the applicable laws. You can access
                            the ARMMFB Services once our onboarding process and Know-Your-Customer (KYC) exercise have been completed.
                            <br /><br />

                            3.2  For compliance purposes, ARMMFB is required to carry out due diligence measures. We are hereby authorized by you to obtain, record and verify information directly or through a third party. To enable us comply with KYC and Anti-Money Laundering (AML) regulations, it is pertinent that you, as our Customer, ensure that all information and documentation provided is accurate, complete, and up to date.
                            <br /><br />
                        </Text>
                        
                        <Text fontSize='16px' fontWeight={600}>4. PRODUCTS AND SERVICES</Text>
                        <Text fontSize='14px' fontWeight={400}>
                            4.1  Accounts: ARMMFB shall offer various types of accounts, including savings accounts, current accounts, and business accounts.
                            <br /><br />

                            4.2  Loans and Credit Services: ARMMFB shall offer multiple lending services through the digital platform or other channels, subject to ARMMFB’s lending policies, eligibility criteria, terms and conditions and applicable regulations.
                            <br /><br />

                            4.3  Savings: ARMMFB shall offer multiple savings products through the digital platform or other channels, subject to ARMMFB’s terms and conditions and applicable regulations.
                            <br /><br />

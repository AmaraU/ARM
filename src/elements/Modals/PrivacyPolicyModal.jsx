    ...
    return (
        ...
        >
            ...
            <ModalContent>
                ...
                <ModalHeader>
                    <Text textAlign='center' fontSize='18px' fontWeight={600}>ARM MICROFINANCE BANK PRIVACY POLICY</Text>
                </ModalHeader>
                ...
                <ModalBody p={0}>
                    <Stack py='16px' px='40px' gap='4px'>
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ARM Microfinance Bank (ARM MFB) is a subsidiary of the ARM MFB , established to complement and strengthen the MFB 's presence in the financial services industry. Operating under a State Microfinance Bank license, ARM MFB aims to provide a broad range of banking services to both retail and SME customers, focusing primarily on Lagos. The bank positions itself as a key partner for young and middle-aged professionals, as well as micro, small, and medium-sized enterprises (MSMEs).
                            <br /><br />
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ...
                            <br />
                            ARM MFB uses the True Depth API within the camera module to enhance the liveness check during the Know Your Customer (KYC) process, as required by account opening regulations. This technology ensures that the video submitted is being recorded live and belongs to the user.
                            <br /><br />
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ...
                            <br />
                            The ARM MFB will not share with other parties, information which you may provide when using the Site, except to the extent necessary to provide services to you, further, to obtaining your consent.
                            <br /><br />
                            With your express consent, we will share your personal data among subsidiaries within the ARM MFB , only to the extent of your permission, and which is necessary to provide services to you. In this case, your right to withdraw consent shall be exercisable at all times.
                            <br /><br />
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ...
                            <ul style={{marginLeft: '20px'}}>
                                ...
                                <li>If You have previously agreed to us using Your Personal Data for direct marketing purposes, You may change Your mind at any time by emailing us at <a style={{color: '#A41857'}} href="mailto:privacy@arm.com.ng">privacy@arm.com.ng</a>.</li>
                            </ul>
                            <br />
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ...
                            submit your complaint to our DPO via <a style={{color: '#A41857'}} href="mailto:privacy@arm.com.ng">privacy@arm.com.ng</a>.
                        ...
                        <Text fontSize='14px' fontWeight={400}>
                            ...
                            <br />
                            Email: <a style={{color: '#A41857'}} href="mailto:privacy@arm.com.ng">privacy@arm.com.ng</a>
                            <br />
